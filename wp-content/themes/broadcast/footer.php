	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3 col-sm-6">
				...
				<p class="footer__contacts"><?php 	echo get_field('adress'); ?></p>
				<div class="socials">
			...
			<div class="col-md-3 col-sm-6">
				<p class="footer__caption"><?php 	echo get_field('contacts'); ?></p>
				<p class="footer__contacts"><span><?php 	echo get_field('phone'); ?></span><br><?php 	echo get_field('email'); ?></p>
